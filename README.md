...
# Fix
In the fixed version of this application simply `htmlspecialchars( SubmittedValue )` is used to convert special characters into their html representation. (http://php.net/manual/de/function.htmlspecialchars.php)
